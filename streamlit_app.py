...
def compute_energy_results(data):
    ...
    # Amplify phantom percentage so small standby draws register visibly.
    # Multiply raw by 3x, capped at 100. Zero stays zero.
    phantom_pct = round(min(100, phantom_pct_raw * 3))
